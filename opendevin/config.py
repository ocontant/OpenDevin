...
DEFAULT_CONFIG: dict = {
    ...
    ConfigType.LLM_EMBEDDING_STRATEGY: None,
    ConfigType.LLM_EMBEDDING_MODEL: None,
    ConfigType.LLM_EMBEDDING_BASE_URL: None,
    ConfigType.LLM_EMBEDDING_API_KEY: None,
    ConfigType.LLM_EMBEDDING_DEPLOYMENT_NAME: None,
    ConfigType.LLM_EMBEDDING_API_VERSION: None,
